...
export default function (PDFJS) {
  ...
  function createLoadingTask(src, options) {
    var source
    if (typeof (src) === 'string') { source = { url: src } } else if (src instanceof Uint8Array) { source = { data: src } } else if (typeof (src) === 'object' && src !== null) { source = Object.assign({}, src) } else { throw new TypeError('invalid src type') }
  ...
  function PDFJSWrapper(canvasElt, annotationLayerElt, emitEvent) {
    ...
    this.printPage = function (dpi, pageNumberOnly) {
      ...
      // var iframeElt = document.createElement('div');
